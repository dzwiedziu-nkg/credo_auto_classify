...
def create_model(images, targets):
    ...
    rf = RandomForestClassifier(n_estimators=40, bootstrap=False, max_features=5, criterion="entropy")
    # ’bootstrap’: False, ’criterion’: ’entropy’,’max_features’: 5, ’n_estimators’: 40}
    clf = rf.fit(X_train4, y_train4)
    clf1=clf
